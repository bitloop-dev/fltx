...
void isolated_f128_ipow()
{
    ...
    bl::f128 signed_value        = bl::ipow(input, signed_exponent);
    bl::f128 wide_signed_value   = bl::ipow(input, wide_signed_exponent);
    bl::f128 wide_unsigned_value = bl::ipow(input, wide_unsigned_exponent);
