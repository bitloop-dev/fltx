/**
 * fltx/detail/fqd_expansion.h - Quad-double normalization and expansion helpers.
 *
...
#ifndef FQD_DETAIL_EXPANSION_INCLUDED
#define FQD_DETAIL_EXPANSION_INCLUDED
...
namespace detail::_qd // primitives and kernels
{
    ...
    // renormalization
    BL_FORCE_INLINE constexpr fqd_s renorm(double c0, double c1, double c2, double c3) noexcept
    {
    ...
    BL_PUSH_PRECISE
    BL_FORCE_INLINE constexpr fqd_s renorm4(double c0, double c1, double c2, double c3) noexcept
    {
        double s, e;
    ...
    BL_FORCE_INLINE constexpr fqd_s renorm5(double c0, double c1, double c2, double c3, double c4) noexcept
    {
        double s, e;
