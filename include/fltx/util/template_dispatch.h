/**
 * fltx/util/template_dispatch.h - Runtime-to-template dispatch helpers.
 *
...
#ifndef FLTX_UTIL_TEMPLATE_DISPATCH_INCLUDED
#define FLTX_UTIL_TEMPLATE_DISPATCH_INCLUDED
#include <array>
#include <string>
#include <type_traits>
#include <tuple>
