...
| `approx_eq` and parity tolerances | same-precision f128/f256 | `contracts/approx_comparison.cpp` | CE: default and custom relative-threshold cases; O: accepted same-precision and rejected scalar/mixed/four-argument calls | — | Covers named defaults, scaling, signed zero, infinities, NaNs, invalid tolerances, symmetry, and exact threshold boundaries |
