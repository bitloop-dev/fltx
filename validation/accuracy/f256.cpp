...
namespace fltx::tests::accuracy
{
    ...
    namespace
    {
        ...
        [[nodiscard]] std::vector<domain> f256_ordinary(std::size_t n)
        {
            return {domains::near_one(n), domains::moderate(n)};
        }

        [[nodiscard]] std::vector<domain> f256_positive(std::size_t n)
        {
        ...
        [[nodiscard]] std::vector<domain> f256_trig(std::size_t n)
        {
            return {
                domains::moderate(n),
                domains::argument_reduction(n),
                trig_domains::quadrant_boundaries<bl::f256>(n)
            };
        }

        [[nodiscard]] std::vector<domain> f256_unit(std::size_t n)
        {
            return {domains::bounded(domains::moderate(n), -0.999, 0.999),
        ...
        [[nodiscard]] domains::binary_domain fmod_quotient_reduction_inputs()
        {
            domains::binary_domain out{
                "quotient_reduction", default_seed ^ 0x29u, {}
            };
            const bl::f256 decimal_lhs = bl::parse<bl::f256>(
                "4.6958550912494028428400315673292717414e+19");
            const bl::f256 decimal_rhs = bl::parse<bl::f256>(
        ...
        {
            domain out{"boundary", default_seed ^ 0x28u, {}};
            out.values = {make_exact_sample(0.0, "+0"),
                          ...
                          {{-2.5, -0x1p-54, 0.0, 0.0}, "just below -2.5"},
                          {{-2.5, 0x1p-54, 0.0, 0.0}, "just above -2.5"},
                          {{2.5, 0.0, -0x1p-108, 0.0}, "third-limb below tie"},
                          {{2.5, 0.0, 0x1p-108, 0.0}, "third-limb above tie"}};
    ...
    int run_f256(csv_writer& output, const options& settings)
    {
        ...
        runner<bl::f256> run(output, settings);
        ...
        parse_moderate.values.push_back(
            ...
            "000151929083932156779959571876312991314467535453337919119460476"
            "479853264131690316978544529902908342617601488442127810607473747"
            "95028008520603179931640625");
        ...
        parse_wide.values.push_back(
            "1.885122618316319232359250242979669614562582553003321176568"
            "9482382071894642432405e-261");
        parse_wide.values.push_back(
            "9.128274632081106901901927373690883633796023409942415385737"
            "7066691381118551853264239e-261");
        run.parse(
            "io",
            "parse",
            {
        ...
        run.binary_exact(
            ...
            qdpp<Float>("qdpp min", [](auto x, auto y) { return qd_min(x, y); }),
        ...
        run.binary_exact(
            ...
            [](const real& x, const real& y) { return x > y ? x : y; },
            qdpp<Float>("qdpp max", [](auto x, auto y) { return qd_max(x, y); }),
        ...
        run.unary_exact(
            ...
            [](auto x) { return bl::f256{static_cast<std::int64_t>(bl::lround(x))}; },
            [](const real& x) {
        ...
        run.unary_exact(
            ...
            [](auto x) { return bl::f256{static_cast<std::int64_t>(bl::llround(x))}; },
            [](const real& x) {
                const real rounded = mpfr::round_away_from_zero(x);
                return rounded == 0 ? real{0} : rounded;
            },
        ...
        run.binary_pair(
            ...
            [](auto x, auto y) {
                int quotient = 0;
                const bl::f256 remainder = bl::remquo(x, y, &quotient);
                const int low_bits = quotient < 0 ? -((-quotient) & 7) : (quotient & 7);
                return std::pair{remainder, bl::f256{static_cast<double>(low_bits)}};
            },
            [](const real& x, const real& y) {
        ...
        run.unary_pair_exact(
            ...
            [](auto x) {
                bl::f256 integral{};
                const bl::f256 fractional = bl::modf(x, &integral);
        ...
        run.unary_pair_exact(
            ...
            [](auto x) {
                int exponent = 0;
                const bl::f256 fraction = bl::frexp(x, &exponent);
                return std::pair{fraction, bl::f256{static_cast<double>(exponent)}};
            },
            [](const real& x) {
        ...
        run.unary_exact(
            ...
            [](auto x) { return bl::f256{static_cast<double>(bl::ilogb(x))}; },
        ...
        auto sqrt_domains = f256_positive(n);
        ...
        run.unary(
            "trigonometric", "sin", f256_trig(n), [](auto x) { return bl::sin(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "cos", f256_trig(n), [](auto x) { return bl::cos(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "tan", f256_trig(n), [](auto x) { return bl::tan(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "atan", f256_ordinary(n), [](auto x) { return bl::atan(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "asin", f256_unit(n), [](auto x) { return bl::asin(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "acos", f256_unit(n), [](auto x) { return bl::acos(x); },
            [](const real& x) {
        ...
        const auto exp_domains = [&] {
            return std::vector<domain>{
                domains::moderate(n, -8.0, 8.0),
                domains::interval("boundary", -700.0, 700.0, n, default_seed ^ 0x45u)};
        };
        run.unary(
            "exponentials", "exp", exp_domains(), [](auto x) { return bl::exp(x); },
            [](const real& x) {
        ...
        run.unary(
            "exponentials", "exp2", exp_domains(), [](auto x) { return bl::exp2(x); },
        ...
        run.unary(
            "logarithms", "log", f256_positive(n), [](auto x) { return bl::log(x); },
            [](const real& x) {
        ...
        run.unary(
            "logarithms", "log2", f256_positive(n), [](auto x) { return bl::log2(x); },
        ...
        run.unary(
            "logarithms", "log10", f256_positive(n), [](auto x) { return bl::log10(x); },
        ...
        run.unary(
            "hyperbolic", "sinh", f256_ordinary(n), [](auto x) { return bl::sinh(x); },
            [](const real& x) {
        ...
        run.unary(
            "hyperbolic", "cosh", f256_ordinary(n), [](auto x) { return bl::cosh(x); },
            [](const real& x) {
        ...
        run.unary(
            "hyperbolic", "tanh", f256_ordinary(n), [](auto x) { return bl::tanh(x); },
            [](const real& x) {
        ...
        run.unary(
            "inverse_hyperbolic", "asinh", f256_ordinary(n), [](auto x) { return bl::asinh(x); },
            [](const real& x) {
        ...
        run.unary(
            ...
            {domains::interval("moderate", 1.0, 20.0, n, default_seed ^ 0x55u),
        ...
        run.unary(
            "special_functions", "erf", f256_ordinary(n), [](auto x) { return bl::erf(x); },
        ...
        run.unary(
            "special_functions", "erfc", f256_ordinary(n), [](auto x) { return bl::erfc(x); },
        ...
        run.unary(
            ...
            {domains::interval("moderate", 0.125, 20.0, n, default_seed ^ 0x65u)},
