...
namespace fltx::tests::accuracy
{
    ...
    namespace
    {
        ...
        [[nodiscard]] std::vector<domain> qd_ordinary(std::size_t n)
        {
        ...
        [[nodiscard]] std::vector<domain> qd_trig(std::size_t n)
        {
            return {
                ...
                trig_domains::quadrant_boundaries<bl::fqd>(n)
            };
        }

        [[nodiscard]] std::vector<domain> qd_unit(std::size_t n)
        {
        ...
        [[nodiscard]] domains::binary_domain fmod_quotient_reduction_inputs()
        {
            ...
            const bl::fqd decimal_lhs = bl::parse<bl::fqd>(
                "4.6958550912494028428400315673292717414e+19");
            const bl::fqd decimal_rhs = bl::parse<bl::fqd>(
    ...
    int run_qd(csv_writer& output, const options& settings)
    {
        ...
        runner<bl::fqd> run(output, settings);
        ...
        run.unary_exact(
            ...
            [](auto x) { return bl::fqd{static_cast<std::int64_t>(bl::lround(x))}; },
            [](const real& x) {
        ...
        run.unary_exact(
            ...
            [](auto x) { return bl::fqd{static_cast<std::int64_t>(bl::llround(x))}; },
            [](const real& x) {
                const real rounded = mpfr::round_away_from_zero(x);
                return rounded == 0 ? real{0} : rounded;
            },
        ...
        run.binary_pair(
            ...
            [](auto x, auto y) {
                int quotient = 0;
                const bl::fqd remainder = bl::remquo(x, y, &quotient);
                const int low_bits = quotient < 0 ? -((-quotient) & 7) : (quotient & 7);
                return std::pair{remainder, bl::fqd{static_cast<double>(low_bits)}};
            },
            [](const real& x, const real& y) {
        ...
        run.unary_pair_exact(
            ...
            [](auto x) {
                bl::fqd integral{};
                const bl::fqd fractional = bl::modf(x, &integral);
        ...
        run.unary_pair_exact(
            ...
            [](auto x) {
                int exponent = 0;
                const bl::fqd fraction = bl::frexp(x, &exponent);
                return std::pair{fraction, bl::fqd{static_cast<double>(exponent)}};
            },
            [](const real& x) {
        ...
        run.unary_exact(
            ...
            [](auto x) { return bl::fqd{static_cast<double>(bl::ilogb(x))}; },
        ...
        auto sqrt_domains = qd_positive(n);
        ...
        run.unary(
            "trigonometric", "sin", qd_trig(n), [](auto x) { return bl::sin(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "cos", qd_trig(n), [](auto x) { return bl::cos(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "tan", qd_trig(n), [](auto x) { return bl::tan(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "atan", qd_ordinary(n), [](auto x) { return bl::atan(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "asin", qd_unit(n), [](auto x) { return bl::asin(x); },
            [](const real& x) {
        ...
        run.unary(
            "trigonometric", "acos", qd_unit(n), [](auto x) { return bl::acos(x); },
            [](const real& x) {
        ...
        run.unary(
            "logarithms", "log", qd_positive(n), [](auto x) { return bl::log(x); },
            [](const real& x) {
        ...
        run.unary(
            "logarithms", "log2", qd_positive(n), [](auto x) { return bl::log2(x); },
        ...
        run.unary(
            "logarithms", "log10", qd_positive(n), [](auto x) { return bl::log10(x); },
        ...
        run.unary(
            "hyperbolic", "tanh", qd_ordinary(n), [](auto x) { return bl::tanh(x); },
            [](const real& x) {
        ...
        run.unary(
            "inverse_hyperbolic", "asinh", qd_ordinary(n), [](auto x) { return bl::asinh(x); },
            [](const real& x) {
        ...
        run.unary(
            "special_functions", "erf", qd_ordinary(n), [](auto x) { return bl::erf(x); },
