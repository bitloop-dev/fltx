...
static_assert(arithmetic_returns<bl::fdd, bl::fdd, bl::fdd>());
static_assert(arithmetic_returns<bl::fdd, const bl::fdd&, const bl::fdd&>());
static_assert(arithmetic_returns<bl::fdd, bl::fdd, bl::fdd_s>());
static_assert(arithmetic_returns<bl::fdd, bl::fdd_s, bl::fdd>());
static_assert(arithmetic_returns<bl::fqd, bl::fqd, bl::fdd>());
static_assert(arithmetic_returns<bl::fqd, bl::fdd, bl::fqd>());
static_assert(arithmetic_returns<bl::fqd, const bl::fqd&, const bl::fdd&>());
static_assert(arithmetic_returns<bl::fqd, const bl::fdd&, const bl::fqd&>());
static_assert(arithmetic_returns<bl::fqd, bl::fqd, bl::fdd_s>());
static_assert(arithmetic_returns<bl::fqd, bl::fdd_s, bl::fqd>());
static_assert(arithmetic_returns<bl::fqd, bl::fqd, bl::fqd_s>());
static_assert(arithmetic_returns<bl::fqd, bl::fqd_s, bl::fqd>());
static_assert(arithmetic_returns<bl::fqd, bl::fdd, bl::fqd_s>());
static_assert(arithmetic_returns<bl::fqd, bl::fqd_s, bl::fdd>());
using qd_product = decltype(std::declval<bl::fqd>() * std::declval<bl::fqd>());
static_assert(arithmetic_returns<bl::fqd, qd_product, bl::fdd>());
static_assert(arithmetic_returns<bl::fqd, bl::fdd, qd_product>());
static_assert(arithmetic_returns<bl::fqd, const qd_product&, const bl::fdd_s&>());
static_assert(arithmetic_returns<bl::fqd, const bl::fdd_s&, const qd_product&>());
static_assert(arithmetic_returns<bl::fqd, qd_product, bl::fqd_s>());
static_assert(arithmetic_returns<bl::fqd, bl::fqd_s, qd_product>());
static_assert(std::same_as<decltype(+std::declval<bl::fdd_s>()), bl::fdd_s>);
static_assert(std::same_as<decltype(-std::declval<bl::fdd_s>()), bl::fdd_s>);
static_assert(std::same_as<decltype(+std::declval<bl::fqd_s>()), bl::fqd_s>);
static_assert(std::same_as<decltype(-std::declval<bl::fqd_s>()), bl::fqd_s>);
